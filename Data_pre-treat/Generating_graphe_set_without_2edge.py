...
for file_itr in range(35):
    ...
    path = data_file_path + '/CMAPSS_project/Graphe_data_set_without_2edge'
    ...
    for flight in range(flight_min,flight_max):
        ...
        graphe_set_file_name = '../Graphe_data_set_without_2edge/File' +str(file+1)+ '/Grapheset' + str(flight) + '.pkl'
        try:
        ...
        graphe_label_file_name = '../Graphe_data_set_without_2edge/File' +str(file+1)+ '/Graphelabel'+ str(flight) + '.pkl'
        try:
    ...
    for flight in range(flight_min,flight_max+1):
        ...
        with open(graphe_set_file_name,'wb') as dataset_to_save:
            ...
            file_name = data_file_path + '/CMAPSS_dataset/' + str(data_rows[file][1]) + '/Engine0' + str(
                engine) + '/Flight' + flight_itr_tostr(flight) + '_norme_without_2edge.csv'
            diff_file_name = data_file_path + '/CMAPSS_dataset/' + str(data_rows[file][1]) + '/Engine0' + str(
                engine) + '/Flight' + flight_itr_tostr(flight) + '_diff_norme_without_2edge.csv'
        ...
        # save label
        test_set_file_name = '../Graphe_data_set_without_2edge/File' + str(file + 1) + '/Graphelabel'+str(flight) + '.pkl'
